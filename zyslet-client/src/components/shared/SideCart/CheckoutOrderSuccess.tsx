...
const CheckoutOrderSuccess: React.FC<CheckoutOrderSuccessProps> = ({
    ...
    return (
        <div className="text-center py-5 sm:py-6 px-2 sm:px-3">
            ...
            <h3 className="text-2xl font-bold text-green-600 mb-3">Order Placed Successfully!</h3>
            ...
            <div className="mt-4 max-w-md mx-auto space-y-2.5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                    <button
                        ...
                        className="w-full px-5 py-3 bg-white text-blue-700 border border-blue-200 rounded-md hover:bg-blue-50 transition-colors text-sm font-medium">
                        Back to Home
                    </button>
                    <button
                        type="button"
                        onClick={onContinueShopping}
                        className="w-full px-5 py-3 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors text-sm font-medium">
                        Continue Shopping
                    </button>
                </div>
            </div>
